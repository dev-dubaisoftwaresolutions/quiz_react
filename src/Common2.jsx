...
const Common2 = (props) => {
      return (
       ...
       <div className="container mt-2">
            ...
            <h3>Quiz(Chapter 1 with Ques2)</h3>
            <br/>
            <img src="line2.png" alt="not found"/>
            <div className="container  mt-5 box">
            <h4 className="text2 p-5">Backend developers focus on:</h4>

            <section><div class="form-check form-check-inline ml-5">
      
            <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option1"/>
            <label class="form-check-label" for="inlineRadio1">Look and feel of the websites</label>
            </div>
            <br/>
            <br/>
            <div class="form-check form-check-inline ml-5">
            <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="option2"/>
            <label class="form-check-label" for="inlineRadio2">User experience</label>
            </div>
            <br/>
            <br/>
            <div class="form-check form-check-inline ml-5">
            <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="option2"/>
            <label class="form-check-label" for="inlineRadio2">inner workings of web applications</label>
            </div>
            <br/>
            <br/>
            <div class="form-check form-check-inline ml-5">
            <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="option2"/>
            <label class="form-check-label" for="inlineRadio2">ALL OF THEM</label>
            </div>
            <br/>
            <br/>
            </section>
